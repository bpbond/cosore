...
This document is the core of the planned ESSD manuscript: summarizing the database, giving stats, describing functions, etc.
...
p <- results_lat %>% 
  ...
  scale_colour_viridis_c(name = "Observations", begin = 0.95, end = 0) +
...
**Figure 7.** Temporal resolution (time interval, minutes; note logarithmic scale) of COSORE data.
...
p <- ggplot(results_res, aes(`Interval (min)`, Records)) +
  geom_col() + 
