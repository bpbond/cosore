...
Records removed (invalid timestamp)     | `r d$Records_removed_timestamp`
Records removed (no flux)   | `r d$Records_removed_NA`
Records (flux < `r d$Flux_lowbound`)  | `r d$Records_removed_toolow`
Records (flux > `r d$Flux_highbound`) | `r d$Records_removed_toohigh`
...
if(is.data.frame(ds$data) & !quick) {
  ...
  dsd %>% 
    ...
    ggplot(aes(Month, CSR_FLUX, color = CSR_PORT, group = CSR_PORT)) + geom_line() ->
    p3
  print(p3)
  # histogram
